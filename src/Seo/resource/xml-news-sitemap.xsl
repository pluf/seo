	...
	<xsl:template match="/">
		<html xmlns="http://www.w3.org/1999/xhtml">
			<head>
				...
				<script type="text/javascript"
					src="http://tablesorter.com/jquery.tablesorter.min.js"></script>
			...
			<body>
				<div id="content">
					...
					<p class="expl">
						You can find more information about XML News sitemaps
						<a
							href="http://www.google.com/support/webmasters/bin/answer.py?hl=en&amp;answer=74288">here</a>
						.
					</p>
					<p class="expl">

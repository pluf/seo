		...
		<html xmlns="http://www.w3.org/1999/xhtml">
			...
			<body>
				<div id="content">
					...
					<p class="expl">
						Generated by
						<a href="http://pluf.ir">Pluf SEO plugin</a>
						, this is an XML Sitemap, meant for consumption by search engines.
					</p>
					<p class="expl">
						You can find more information about XML Video sitemaps
						<a
							href="http://www.google.com/support/webmasters/bin/answer.py?hl=en&amp;answer=80472">here</a>
						.
					</p>
					<p class="expl">
									...
									<tr>
										...
										<td>
											<xsl:variable name="thumbURL">
												<xsl:value-of
													select="video:video/video:thumbnail_loc" />
											</xsl:variable>

											<xsl:variable name="flvURL">
												<xsl:value-of
													select="video:video/video:player_loc" />
											</xsl:variable>
										...
										<td>
											<xsl:variable name="desc">
												<xsl:value-of
													select="video:video/video:description" />
											</xsl:variable>
											<xsl:choose>
												...
												<xsl:otherwise>
													<xsl:value-of
														select="concat(substring($desc,1,200),' ...')" />
												</xsl:otherwise>
											</xsl:choose>
										</td>

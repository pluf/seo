...
/**
 * Updates Seo_Content information
 *
 * @author hadi <mohammad.hadi.mansouri@dpq.co.ir>
 */
class Seo_Form_ContentUpdate extends Pluf_Form_Model
{
    ...
    public function clean_url()
    {
        ...
        if (empty($url))
            return null;
            // Note: If old URL is same as new URL we do not check uniqueness
            // of the name.
        if (strcmp($url, $this->model->url) === 0) {
            return $url;
        }
